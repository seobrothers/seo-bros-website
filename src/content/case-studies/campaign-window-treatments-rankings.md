---
title: 140% organic traffic lift for a Southern California window treatment installer
type: campaign
...
timeframe: 6 months
keyTactics:
  - Dedicated location pages for each priority community
  - Product-category pages broken out by blinds, shutters, and shades
  - Technical audit and metadata refresh in month one
  - Citation cleanup and link work to defend new positions
charts:
  - kind: line
    ...
    series:
      - label: Organic sessions
        values: [57, 77, 114, 127, 102, 137]
      - label: Tracked leads (GA4)
        values: [0, 4, 5, 9, 10, 20]
---
