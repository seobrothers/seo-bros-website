...
Billing. From December 4 a partner with billing access has a Billing section in the Portal: invoices with their status, a statement, receipts, payment methods on file with a default card, and autopay. Organization settings gained the partner's contact details, address and team on the same day. Over the next day the details were tightened: invoices due today no longer show as past due, a failed payment says so plainly, and every page got a proper title.

Campaigns show their agreement. From December 10 a campaign's page shows the billing agreement behind it, and from December 11 a partner can see all of their agreements in one place.

Scope became a timeline on December 19. A campaign's details page now shows what the campaign includes quarter by quarter, and a proposed change appears as proposed, without moving anything, until it is approved. Campaign rules, the standing instructions our team follows for a campaign, got their own form the same day.

Approval requirements replaced the old permission settings on December 11. For each campaign a partner can say which kinds of work need their sign-off before it goes out and which do not.

The discovery request form improved on December 9: a partner picks the prospect's Business Profile from a search and chooses competitors from a list rather than typing either.
