...
1. A piece of content now has a share page. Open the link, read the draft, leave feedback inline, and approve it there when it is right.
2. The campaign plan gained a share link from the Portal on the 12th, so an agency could forward the plan to a client without giving them a login.
3. Smaller things: the Portal works on a phone now, with a proper sidebar menu, and a loading bar shows when a page is slow to arrive. The dashboard shows discoveries from the last thirty days rather than all of them, and new team members are no longer added to every campaign by default; you add them to the ones they need.

### 1. The content share page

Every note is counted and kept with the draft. From the 12th the Portal's plan pages pointed content approvals at that page instead of asking for approval in the plan table, and each plan row gained a notes column that opens the activity around it. Rejecting a plan item became a status you choose rather than a click you cannot take back. Completed deliverables got their own pages, and when a piece was ready for review the row linked straight to the document.
...
### 1. Content assets rebuilt

Drafts got revisions, drag-and-drop uploads, images pasted straight into comments, and PDFs and other attachments inline. Screen recordings embed in a draft's notes. A draft can be published from the same page it was written on.
...
The spreadsheet was still the delivery format; the work of producing it stopped being a person's job. The replacement came in April.
