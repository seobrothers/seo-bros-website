...
The structure work behind this lives in [our keyword mapping guide](/guides/keyword-mapping/).
...
The full framework is in [our local SEO guide](/guides/local-seo/).
...
For the wider audit framework, see [our SEO audit guide](/guides/seo-audit/).
...
We run this white-label for agencies with clinic clients, and direct for clinics that come to us. If you have a hair transplant client whose consultations are not matching the search volume in their market, run a [free discovery](/tideworthy-sign-up/) and we will show you exactly where the leverage is, then deliver the fix under your brand.
