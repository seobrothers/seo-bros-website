...
The audit also informs whether you need to disavow anything. We've written separately on [the disavow tool](/guides/google-disavow-tool/) and why most sites should not use it, but the audit is where you'd identify candidates.
...
Treated separately. Effective in some contexts, requires real operational discipline to do well. Full breakdown in our [Private Blog Networks guide](/guides/private-blog-networks/).
...
1. **Audit your current profile.** Total referring domains, do-follow ratio, authority/relevance distribution, anchor text mix. This is foundational.
...
If you're trying to figure out what link-building strategy actually maps to your client's situation, [get in touch](/tideworthy-sign-up/) and we'll walk through the budget-timeline-risk math with you.
