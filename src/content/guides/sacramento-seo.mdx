...
- **Davis**: a separate university town with its own light search.
...
**Build real suburb pages, because here they earn their keep.** Citrus Heights, Elk Grove, Rocklin, Roseville, and Folsom carry genuine standalone search. Make each one locally specific, tied to the actual community.

**Treat the Placer County cluster as its own zone.** Rocklin and Roseville sit together in South Placer with their own growth and their own search, so a business that serves them should speak to that area directly.
